...
%-------------------------------------------------------------------------------
\name{Ethan N.\ W.\ Epperly}{}
\position{Miller Research Fellow{\enskip\cdotp\enskip}Department of Mathematics}
\address{845 Evans Hall, University of California, Berkeley}

\mobile{+1 925-219-6742}
\email{eepperly@berkeley.edu}
\homepage{ethanepperly.com}
\github{eepperly}
%\linkedin{mylinkedin}
% \gitlab{my-gitlab-id}
...
\makecvfooter
  {\today}
  {Ethan N.\ W.\ Epperly ~~~·~~~ Curriculum Vitae}
  {\thepage}
